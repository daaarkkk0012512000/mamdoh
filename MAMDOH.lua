...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MAMDOH.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S MAMDOH -X kill
screen -S MAMDOH ./MAMDOH
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MAMDOHTEAM/Files_Boyka/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,921552446,870759959,1238790800,1282382975}   
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMAMDOHW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(921552446) then  
var = true  
elseif tonumber(user_id) == tonumber(870759959) then
var = true 
elseif tonumber(user_id) == tonumber(1238790800) then
var = true
...
local MAMDOH_Msg = ''  
if msgs < 100 then 
MAMDOH_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MAMDOH_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MAMDOH_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MAMDOH_Msg = 'متفاعل' 
elseif msgs < 1200 then 
MAMDOH_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MAMDOH_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MAMDOH_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MAMDOH_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MAMDOH_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MAMDOH_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MAMDOH_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MAMDOH_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MAMDOH_Msg = 'رب التفاعل'  
end 
return MAMDOH_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMAMDOH(msg,data) -- بداية العمل
if msg then
...
if DevMAMDOHW(msg) then
local bl = ' ❈ اهلا عزيزي آلمـطـور\n ❈ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ❈ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ❈ من خلاال الكيبورت خاص بك\n ❈ قناة سورس البوت [اضغط هنا](t.me/SOURCE_MAMDOH)'
local keyboard = {
...
SourceMAMDOHr = '❈ اهلا عزيزي\n ❈ انا بوت اسمي '..Namebot..'\n ❈ اختصاصي حمايه الكروبات\n ❈ من تكرار والسبام والتوجيه والخ…\n ❈ لتفعيلي اتبع الاخطوات…↓\n ❈ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❈ [قناة سورس البوت](http://t.me/SOURCE_MAMDOH)'
end 
send(msg.chat_id_, msg.id_, SourceMAMDOHr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevMAMDOHW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMAMDOHW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,MAMDOH_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❈' and DevMAMDOHW(msg) then  
...
if text == 'تعطيل التواصل ❈' and DevMAMDOHW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❈' and DevMAMDOHW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❈' and DevMAMDOHW(msg) then  
...
if text == 'ضع كليشه ستارت ❈' and DevMAMDOHW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❈ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❈' and DevMAMDOHW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❈ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❈' and DevMAMDOHW(msg) then 
...
if text == 'تحديث السورس ❈' and DevMAMDOHW(msg) then 
os.execute('rm -rf MAMDOH.lua')
os.execute('wget https://raw.githubusercontent.com/MAMDOHTEAM/MAMDOH/master/MAMDOH.lua')
send(msg.chat_id_, msg.id_,' ❈ تم تحديث السورس \n ❈ لديك اخر اصدار لسورس ممدوح\n ❈ الاصدار » { 1.3v}')
dofile('MAMDOH.lua')  
end
if text == 'الاصدار ❈' and DevMAMDOHW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈ اصدار سورس ممدوح \n ❈ الاصدار »{ 1v}')
end
if text == 'قناه تحديثات البوت ❈' and DevMAMDOHW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈ [تحديثات البوت](t.me/Source_mamdoh) \n ❈ [قناه السورس](t.me/SOURCE_MAMDOH)')
end
if text == "ضع اسم للبوت ❈" and DevMAMDOHW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❈ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❈' and DevMAMDOHW(msg) then 
...
if text == 'المشتركين ❈' and DevMAMDOHW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❈ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❈' and DevMAMDOHW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❈ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❈") and DevMAMDOHW(msg) then
...
if text == ("قائمه العام ❈") and DevMAMDOHW(msg) then
...
if text == ("قائمه الكتم العام ❈") and DevMAMDOHW(msg) then
...
if text=="اذاعه خاص ❈" and msg.reply_to_message_id_ == 0 and DevMAMDOHW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل الان اذاعتك؟ \n ❈ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❈" and msg.reply_to_message_id_ == 0 and DevMAMDOHW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل الان اذاعتك؟ \n ❈ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❈" and msg.reply_to_message_id_ == 0 and DevMAMDOHW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل الان اذاعتك؟ \n ❈ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❈" and msg.reply_to_message_id_ == 0  and DevMAMDOHW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❈" and msg.reply_to_message_id_ == 0  and DevMAMDOHW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❈' and DevMAMDOHW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❈" and DevMAMDOHW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❈" and DevMAMDOHW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❈  عدد الكروبات الان » { '..#group..' }'..MAMDOHk..''..MAMDOH..'\n❈  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMAMDOHW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevMAMDOHW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMAMDOHW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMAMDOHW(msg) then
...
local MAMDOH1_Msg = database:get(bot_id.."MAMDOH1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MAMDOH1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if MAMDOH_Msg and not Special(msg) then  
local MAMDOH_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MAMDOH_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMAMDOHW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMAMDOHW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMAMDOHW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❈ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMAMDOHW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❈ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❈" and DevMAMDOHW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❈ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❈$") and DevMAMDOHW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❈ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❈" and DevMAMDOHW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❈" and DevMAMDOHW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❈ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❈" and DevMAMDOHW(msg) then  
...
database:sadd(bot_id.."MAMDOH:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MAMDOH:blocname"..msg.chat_id_)
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."MAMDOH:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."MAMDOH:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MAMDOH:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MAMDOH:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MAMDOH:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MAMDOH:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Boykaa_new(Boyka1,Boyka2)
if Boyka2 and Boyka2.first_name_ then 
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."MAMDOH:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MAMDOH:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."MAMDOH:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."MAMDOH:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Boyka_nnn2) == tonumber(Boyka_nnn) or tonumber(Boyka_nnn2) > tonumber(Boyka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MAMDOH:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❈ عزيزي >>["..Boyka2.username_.."](https://t.me/"..(Boyka2.username_ or "pvv_v")..")\n❈ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MAMDOH:teh"..msg.chat_id_).."} بجانب اسمك\n❈ عدد المحاولات المتبقيه {"..(tonumber(Boyka_nnn) - tonumber(Boyka_nnn2)).."}")
end
end
end
end
...
local MAMDOHChengName = database:get(bot_id.."MAMDOH:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MAMDOHChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MAMDOHChengName..']')
database:del(bot_id.."MAMDOH:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MAMDOHChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MAMDOH:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MAMDOHChengUserName = database:get(bot_id.."MAMDOH:Cheng:UserName"..data.id_)
if not data.username_ then 
if MAMDOHChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MAMDOHChengUserName..']')
database:del(bot_id.."MAMDOH:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MAMDOHChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MAMDOH:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MAMDOHChengPhoto = database:get(bot_id.."MAMDOH:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MAMDOHChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MAMDOH:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MAMDOHChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MAMDOH:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
[𝙳𝙴𝚅 : 𝙼𝙰𝙼𝙳𝙾𝙷₁](https://t.me/MAM_DOH)
[𝙳𝙴𝚅 : 7𝙰𝙼𝙾₂](https://t.me/Q_A_S1)
[𝙳𝙴𝚅 : 𝚂𝙷𝙰𝙳𝙸𝙾₃](https://t.me/Shadio_1)

[𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙰𝙼𝙳𝙾𝙷💬](https://t.me/SOURCE_MAMDOH)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevMAMDOHW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevMAMDOHW(msg) then    
dofile('MAMDOH.lua')  
send(msg.chat_id_, msg.id_, ' ❈ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevMAMDOHW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMAMDOHW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevMAMDOHW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMAMDOHW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMAMDOHW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMAMDOHW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMAMDOHW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMAMDOHW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMAMDOHW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMAMDOHW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevMAMDOHW(msg) then
...
if text == 'الملفات' and DevMAMDOHW(msg) then
t = ' ❈ ملفات السورس ممدوح ↓\n≪━━━━━━━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevMAMDOHW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MAMDOHTEAM/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❈ اهلا بك في متجر ملفات ممدوح\n ❈ ملفات السورس ↓\n≪━━━━━━━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━━━━━━━≫\n ❈ علامة تعني { ✓ } ملف مفعل\n ❈ علامة تعني { ✘ } ملف معطل\n ❈ قناة سورس ممدوح ↓\n".." ❈ [اضغط هنا لدخول](t.me/SOURCE_MAMDOH) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMAMDOHW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MAMDOHTEAM/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('MAMDOH.lua')  
else
send(msg.chat_id_, msg.id_," ❈ عذرا الملف لايدعم سورس ممدوح \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMAMDOHW(msg) then
...
if text == "مسح الملفات" and DevMAMDOHW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❈ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMAMDOHW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMAMDOHW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_MAMDOH(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MAMDOH, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MAMDOH, nil)
return false 
end
...
database:set(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❈ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MAMDOH1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MAMDOH1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❈ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MAMDOH1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MAMDOH1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MAMDOH1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❈ ارسل الكلمه الان")  
database:set(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MAMDOH1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MAMDOH1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MAMDOH1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MAMDOH1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MAMDOH1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MAMDOH1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❈ قائمة المنع \n≪━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local MAMDOH_Msg = database:get(bot_id.."MAMDOH1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MAMDOH_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevMAMDOHW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❈ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMAMDOHW(msg) then
...
if text == 'تفعيل الاذاعه' and DevMAMDOHW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMAMDOHW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ممدوح').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ممدوح')
local MAMDOH_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..MAMDOH_Msg[math.random(#MAMDOH_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMAMDOHW(msg) then 
...
if text == ("مسح ردود المطور") and DevMAMDOHW(msg) then 
...
if text == ("ردود المطور") and DevMAMDOHW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❈ قائمة ردود المطور \n≪━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMAMDOHW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevMAMDOHW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ممدوح').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevMAMDOHW(msg) then   
...
if text == 'تعطيل المغادره' and DevMAMDOHW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MAMDOH')..') '
...
-- vardump(data) 
MAMDOHdx(msg.chat_id_, msg.id_, ' ❈ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❈ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❈ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❈ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMAMDOHW(msg) then
...
*❈م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━━━━━━━≫ٴ
彡 .[𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙰𝙼𝙳𝙾𝙷💬](t.me/SOURCE_MAMDOH)➢ 
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ممدوح')
...
MAMDOH = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MAMDOH)
...
--------------------------------------------------------------------------------------------------------------
SourceMAMDOH(data.message_,data)
...
------------------------------------------------------------------------
local MAMDOHAbot = database:get(bot_id.."MAMDOH1:Add:Filter:Rp2"..text..result.chat_id_)   
if MAMDOHAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❈ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❈ ["..MAMDOHAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MAMDOH1_Msg = database:get(bot_id.."MAMDOH1:Add:Filter:Rp2"..text..result.chat_id_)   
if MAMDOH1_Msg then    
send(msg.chat_id_, msg.id_," ❈ "..MAMDOH1_Msg)
